...
FREQ_BEGIN = 200*10000  # 20 kHz
FREQ_END = 350*10000  # 500 kHz
STEPS = 100  # points between begin and end freq's

DDS_GAIN = 10  # 0-255
TIA_GAIN = 0  # 0-255 0 is maximum gain, 255 is minimum gain

output_dir = r"C:\CorroSenseBoardV4\measurements\TIA test"
...
for tia in range(0, 10, 1):
    TIA_GAIN = tia  # 0-255 0 is maximum gain, 255 is minimum gain
